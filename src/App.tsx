        ...
        <aside className="w-80 space-y-6">
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Textarea id="transcription_prompt" className="h-20 resize-none leading-relaxed" placeholder="Inclua palavras-chave mencionadas no video separados por vírgula"/>
            </div>

            <Button type="submit" className="w-full">
              Carregar video 
              <Upload className="w-4 h-4 ml-2"/></Button>
          </form>
